...
**For more details or to use this code, please refer to and cite the following papers:**  
[1] Qingtao Pan, et al. Adaptive dissemination process in weighted hypergraphs[J]. Expert Systems with Applications, 2025.  
[2] Qingtao Pan, et al. A state transition-based method for influence evaluation in networks[J]. Chaos, Solitons and Fractals, 2025.
